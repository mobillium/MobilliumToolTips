...
open class EasyTipView: UIView {
    ...
    public struct Preferences {
        ...
        public struct Positioning {
            ...
            public var contentHInset        = CGFloat(0)
            public var contentVInset        = CGFloat(0)
...
// MARK: - Rotation Support -
    @objc func handleRotation() {
        guard let _ = superview, presentingView != nil else { return }
        
        // TODO: open this if you want to change accoring to orientation
    ...
    fileprivate func arrange(withinSuperview superview: UIView) {
        ...
        case .bottom, .top, .any:
            if frame.width < refViewFrame.width {
                ...
                arrowTipXOrigin = abs(frame.minX - refViewFrame.x) + refViewFrame.width / 2
            }
        ...
        case .right, .left:
            if frame.height < refViewFrame.height {
                ...
                arrowTipXOrigin = abs(frame.minY - refViewFrame.y) + refViewFrame.height / 2
            }
...
// MARK: - Drawing -
    ...
    fileprivate func drawBubbleBottomShape(_ frame: CGRect, cornerRadius: CGFloat, path: CGMutablePath) {
        ...
        path.addArc(tangent1End: CGPoint(x: frame.minX, y: frame.minY + frame.height), tangent2End: CGPoint(x: frame.x, y: frame.y), radius: cornerRadius)
        path.addArc(tangent1End: CGPoint(x: frame.minX, y: frame.minY), tangent2End: CGPoint(x: frame.x + frame.width, y: frame.y), radius: cornerRadius)
        path.addArc(tangent1End: CGPoint(x: frame.minX + frame.width, y: frame.minY), tangent2End: CGPoint(x: frame.x + frame.width, y: frame.y + frame.height), radius: cornerRadius)
        path.addArc(tangent1End: CGPoint(x: frame.minX + frame.width, y: frame.minY + frame.height), tangent2End: CGPoint(x: frame.x, y: frame.y + frame.height), radius: cornerRadius)
    }
    
    fileprivate func drawBubbleTopShape(_ frame: CGRect, cornerRadius: CGFloat, path: CGMutablePath) {
        
        path.addArc(tangent1End: CGPoint(x: frame.minX, y: frame.minY), tangent2End: CGPoint(x: frame.x, y: frame.y + frame.height), radius: cornerRadius)
        path.addArc(tangent1End: CGPoint(x: frame.minX, y:  frame.minY + frame.height), tangent2End: CGPoint(x: frame.x + frame.width, y: frame.y + frame.height), radius: cornerRadius)
        path.addArc(tangent1End: CGPoint(x: frame.minX + frame.width, y: frame.minY + frame.height), tangent2End: CGPoint(x: frame.x + frame.width, y: frame.y), radius: cornerRadius)
        path.addArc(tangent1End: CGPoint(x: frame.minX + frame.width, y: frame.minY), tangent2End: CGPoint(x: frame.x, y: frame.y), radius: cornerRadius)
    }
    ...
    fileprivate func drawBubbleRightShape(_ frame: CGRect, cornerRadius: CGFloat, path: CGMutablePath) {
        ...
        path.addArc(tangent1End: CGPoint(x: frame.minX, y: frame.minY), tangent2End: CGPoint(x: frame.x, y: frame.y + frame.height), radius: cornerRadius)
        path.addArc(tangent1End: CGPoint(x: frame.minX, y: frame.minY + frame.height), tangent2End: CGPoint(x: frame.x + frame.width, y: frame.y + frame.height), radius: cornerRadius)
        path.addArc(tangent1End: CGPoint(x: frame.minX + frame.width, y: frame.minY + frame.height), tangent2End: CGPoint(x: frame.x + frame.width, y: frame.height), radius: cornerRadius)
